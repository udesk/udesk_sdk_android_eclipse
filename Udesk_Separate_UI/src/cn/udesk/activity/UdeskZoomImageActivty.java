...
public class UdeskZoomImageActivty extends Activity implements OnClickListener {
	...
	public void saveImage() {
		...
		try {
			...
			final File folder = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM);
			...
			if (copyFile(oldFile, newFile)) {
				...
				runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						Toast.makeText(UdeskZoomImageActivty.this,
								getResources().getString(R.string.udesk_success_save_image) + folder.getAbsolutePath(),
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						Toast.makeText(UdeskZoomImageActivty.this,
								getResources().getString(R.string.udesk_fail_save_image), Toast.LENGTH_SHORT).show();
						UdeskZoomImageActivty.this.finish();
					}
				});
			}
